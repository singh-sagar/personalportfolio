          ...
          <div className="w-full bg-white px-20 flex flex-col gap-3">
            ...
            <div className="w-full bg-white flex gap-5">
              ...
              <SocialButton
                ...
                popupContent={
                  <TwitterPop text="@sagar_singh" imageSrc="/twitter.png" />
                }
              />
              {/* LinkedIn */}
              <SocialButton
                ...
                popupContent={
                  <TwitterPop text="@sagar_singh" imageSrc="/linkedin.png" />
                }
              />
              {/* GitHub */}
              <SocialButton
                ...
                popupContent={
                  <TwitterPop text="@sagar_singh" imageSrc="/git.png" />
                }
              />
              {/* Gmail */}
              <SocialButton
                ...
                popupContent={
                  <Popup text="@sagarlm07@gmail.com" imageSrc="/vector.png" />
                }
              />
              {/* Discord */}
              <SocialButton
                ...
                popupContent={
                  <Popup text="@singh_sagar" imageSrc="/vector.png" />
                }
              />
            </div>
          </div>
