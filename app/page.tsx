...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen bg-white font-sans ">
      ...
      <div className=" min-h-screen max-w-6xl w-full bg-red-100 pt-20 mx-auto">
           {/* First Div: About Section */}
        {/* need fixing */}
       <div className=" max-w-6xl w-full  p-1  flex  justify-between items-center px-20 bg-black"> 
